...
~~~sh
git clone git@github.com:nko3/go-horse-go.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-go-horse-go --password BfhE/UoDmuW1B0KK
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/go-horse-go" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280888
[3]: https://github.com/nko3/go-horse-go
